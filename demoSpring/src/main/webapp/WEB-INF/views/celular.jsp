...
<body>
	<div class="container">
		<div class="header clearfix">
			<h3 class="text-muted">Celular</h3>
		</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			Util.initTable('<c:url value="/celular/api/records"/>');
			...
			$('#btnSearch').click(function () {
				...
				Util.updateTable('<c:url value="/celular/api/records?"/>' + $('#frmSearch').serialize())
	...
	<!-- Modal -->
	<c:import url="include/modal1.jsp" />
</body>
</html>